...
class AdminProjetController extends AbstractController
{
    ...
    public function new(Request $request, ProjetRepository $projetRepository): Response
    {
        ...
        // https://symfony-com.translate.goog/blog/a-week-of-symfony-810-4-10-july-2022?utm_source=Symfony+Blog+Feed&utm_medium=feed&_x_tr_sl=en&_x_tr_tl=fr&_x_tr_hl=fr&_x_tr_pto=sc
        return $this->render('admin_projet/new.html.twig', [
            'projet' => $projet,
            'form' => $form,
        ]);
    }
